...
## Project Structure
    ...
    ├── testapiautosetting_126370  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126370`
...
2. Clone this repo and `cd testapiautosetting_126370`
